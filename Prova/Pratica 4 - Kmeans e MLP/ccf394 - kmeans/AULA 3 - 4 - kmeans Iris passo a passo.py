...
def kmeans(dataset, k):
    ...
    while centroides_antigos is None or diferenca_centroides(centroides, centroides_antigos) > 0:
        ...
        diferenca = diferenca_centroides(centroides, centroides_antigos) if centroides_antigos is not None else float(
            'inf')
    return clusters
...
k = 3
centroides = inicializar_centroides(iris.data.tolist(), k)
